...
BASE_DOMAIN="${BASE_DOMAIN:-your-domain.com}"  # Замените на ваш домен
...
add_user() {
    ...
    echo "🔗 VLESS-ссылка:"
    echo "vless://$uuid@$BASE_DOMAIN:443?security=reality&encryption=none&alpn=h2,http/1.1&headerType=none&fp=chrome&type=tcp&flow=xtls-rprx-vision&sni=www.google.com&pbk=$public_key&sid=$short_id#$username"
}
